...
import imagen from '../../assets/composicion-creativa2-carretes.png'
import { Navcbar } from '../Navbar/Navcbar';

//ES LA SECCION PRINCIPAL DESPUES DEL NAVBAR
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    const createShape = () => {
      ...
      const size = 120 + Math.random() * 260; // Pills MÁS GRANDES (antes 80 + 120)
  ...
  return (
    <>
      ...
      >
        ...
        {/* Navbar para desktop (fuera del Container) */}
   

        <Container fluid className="position-relative p-0 overflow-hidden" style={{
          zIndex: 10,
          marginTop: '0', // Reset para desktop
          '@media (max-width: 992px)': {
            marginTop: '80px' // Espacio para el navbar en móvil
          }
        }}>

          {/* Navbar para móvil (dentro del Container) */}
          ...
          <Row className="h-100 align-items-center p-5">
            ...
            <Col lg={6} md={12} className="px-4 px-lg-5 p-5">
              <div
              ...
              >
                ...
                >
                  Ahora es mas facil acceder a tu iPhone...!
                </p>

                <div className="d-flex gap-3 flex-wrap">
                  <button
                    className="hero-button hero-button-primary btn"
                    style={{
                      padding: '15px 30px',
                      fontSize: '1.1rem',
                      fontWeight: 'bold',
            ...
            <Col lg={6} md={12} className="d-flex justify-content-center align-items-center py-5 py-lg-0 mt-5">
              <div className="d-none d-md-block justify-content-center align-items-center">

                <img src={imagen} alt="" style={{ animation: 'float 6s ease-in-out infinite' }} />
        ...
        {/* Solo efectos de luminosidad - SIN pills estáticas */}
        <div
          style={{
            position: 'absolute',
            top: '20%',
